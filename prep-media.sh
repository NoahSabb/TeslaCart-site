...
soldering-wires:mp4 boards-flatlay:jpg pcb-layout:jpg power-dash:mp4 gps-showcase:mp4 camera-rail-build:mp4 cad-steering-1:mp4 cad-steering-2:mp4 drawio-timelapse:mp4 jetson-unboxing:mp4"
